-- CreateIndex: case-insensitive index on comm_plan_name for get_community_metrics function
CREATE INDEX IF NOT EXISTS "idx_311_comm_plan_lower" ON "requests_311" (LOWER("comm_plan_name"));

-- CreateIndex: case-insensitive index on census_language.community for population lookups
CREATE INDEX IF NOT EXISTS "idx_census_community_lower" ON "census_language" (LOWER("community"));

-- CreateFunction: get_community_metrics
-- Previously maintained out-of-band in prisma/functions/; now tracked in migrations.
